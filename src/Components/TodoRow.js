...
import { completeTodo, markTodoPending } from '../redux/actions/TodoActions';
...
export default function TodoRow({ todo }) {
    ...
    /* 1. Navigate to the route with params */
        <TouchableOpacity
            ...
            onPress={() => navigation.navigate('TodoScreen', { todo, name: todo.title })}
            >
